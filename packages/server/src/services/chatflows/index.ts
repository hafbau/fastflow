import { ICommonObject, removeFolderFromStorage } from 'fastflow-components'
import { StatusCodes } from 'http-status-codes'
import { QueryRunner } from 'typeorm'
import { ChatflowType, IReactFlowObject } from '../../Interface'
import { FASTFLOW_COUNTER_STATUS, FASTFLOW_METRIC_COUNTERS } from '../../Interface.Metrics'
...
const saveChatflow = async (newChatFlow: ChatFlow): Promise<any> => {
    try {
        ...
        appServer.metricsProvider?.incrementCounter(
            dbResponse?.type === 'MULTIAGENT' ? FASTFLOW_METRIC_COUNTERS.AGENTFLOW_CREATED : FASTFLOW_METRIC_COUNTERS.CHATFLOW_CREATED,
