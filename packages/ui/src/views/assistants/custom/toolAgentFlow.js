                ...
                inputParams: [
                    {
                        ...
                        type: 'string',
                        description:
                            'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.getflowstack.ai/memory#ui-and-embedded-chat">more</a>',
                        default: '',
            ...
            data: {
                ...
                inputParams: [
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        description:
                            'Allow image input. Refer to the <a href="https://docs.getflowstack.ai/using-flowise/uploads#image" target="_blank">docs</a> for more details.',
                        default: false,
                        optional: true,
