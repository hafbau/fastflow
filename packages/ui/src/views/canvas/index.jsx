...
// const
import { FASTFLOW_CREDENTIAL_ID } from '@/store/constant'
    ...
    const handleSaveFlow = (chatflowName) => {
        if (reactFlowInstance) {
            const nodes = reactFlowInstance.getNodes().map((node) => {
                ...
                if (Object.prototype.hasOwnProperty.call(nodeData.inputs, FASTFLOW_CREDENTIAL_ID)) {
                    nodeData.credential = nodeData.inputs[FASTFLOW_CREDENTIAL_ID]
                    nodeData.inputs = omit(nodeData.inputs, [FASTFLOW_CREDENTIAL_ID])
                }
                node.data = {
                    ...nodeData,
                    selected: false
