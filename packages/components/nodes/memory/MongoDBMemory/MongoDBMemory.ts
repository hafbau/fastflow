    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'string',
                description:
                    'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.getflowstack.ai/memory/long-term-memory#ui-and-embedded-chat">more</a>',
                default: '',
...
const initializeMongoDB = async (nodeData: INodeData, options: ICommonObject): Promise<BufferMemory> => {
    ...
    const driverInfo = { name: 'Fastflow', version: (await getVersion()).version }
